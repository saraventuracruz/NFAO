function [XK, xk, lambdak,iter, cond_H] = augmented_lagrangian_method_SR1(x, x0, objFunction, constraints, mu0,lambda0, eps)
...
while(true)
    ...
    [~,xk,~,~] = SR1 (grad_al, H0_al,transpose(x), xk, eps);
    XK = [XK;xk];
    t = 0;
